...
const validateProductCreate = [
  ...
  body("type")
    .isIn(["red", "white", "sparkling", "whisky", "rose", "other"])
    .withMessage("Loại sản phẩm không hợp lệ"),
  body("price")
    .isInt({ min: 1000 })
    .withMessage("Giá phải là số nguyên dương (tối thiểu 1,000đ)"),
  body("stock")
    .optional()
    .isInt({ min: 0 })

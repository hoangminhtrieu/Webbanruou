...
module.exports = {
  ...
  vnpay: {
    ...
    hashSecret:
      process.env.VNPAY_HASH_SECRET || "RAOEXHYVSDDIIENYWSLDIIZTANXUXZFJ",
    url:
  ...
  momo: {
    ...
    secretKey:
      process.env.MOMO_SECRET_KEY || "at67qH6mk8w5Y1nAyMoTkAVbmczrq1vU",
    apiUrl: "https://test-payment.momo.vn/v2/gateway/api/create",
    returnUrl:
      process.env.MOMO_RETURN_URL ||
      "http://localhost:3001/api/payments/momo/callback",
    notifyUrl:
      process.env.MOMO_NOTIFY_URL ||
      "http://localhost:3001/api/payments/momo/ipn",
  ...
  stripe: {
    ...
    publishableKey:
      process.env.STRIPE_PUBLISHABLE_KEY || "pk_test_YOUR_STRIPE_PK",
    webhookSecret:
  ...
  jwt: {
    secret:
      ...
      "vinova-super-secret-key-2025-change-in-production",
    refreshSecret:
      process.env.JWT_REFRESH_SECRET || "vinova-refresh-secret-2025",
    expiresIn: "7d",
